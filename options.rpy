...
define config.name = _("Ashes of the Unbound")
...
define gui.about = _p("""
IOH es un equipo creativo dedicado al desarrollo de experiencias interactivas, donde la narrativa y la ambientación juegan un papel fundamental. Nuestro objetivo es crear mundos inmersivos que conecten con el jugador, combinando historia, arte y tecnología en cada proyecto.

Nos especializamos en el desarrollo de novelas visuales y juegos narrativos, cuidando cada detalle: desde los personajes hasta los escenarios, para ofrecer una experiencia única. Creemos en el poder de las decisiones, en las historias que evolucionan con el jugador y en los universos que dejan huella.

Este proyecto es una muestra de nuestra visión: crear algo más que un juego, una experiencia.
""")
...
define build.name = "OmarIzanHector"
...
define config.save_directory = "OmarIzanHector-1768804656"
