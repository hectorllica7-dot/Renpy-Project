...
style quick_button_text:
    ...
    color "#c9b28a"        # beige madera
    hover_color "#ffffff"
    outlines [(2, "#000000", 0, 0)]  # borde negro para contraste
...
##Espaciado entre botones
        textbutton "Jugar":
            action Start() 
            text_size 50 
            hovered Play("sound", "audio/choose_sound.mp3")
            activate_sound "audio/start_sound.mp3"
        textbutton "Cargar": 
    ...
    ##Image as a title of the game, in the center of the screen
    add "images/title/title.png" xalign 0.5 yalign 0.1
...
style slot_time_text:
    color "#c9b28a"       # dorado suave
    hover_color "#ffffff"
    outlines [(2, "#000000", 0, 0)]
style slot_name_text is slot_button_text
style slot_name_text:
    color "#ffffff"       # nombre del save
    hover_color "#c9b28a"
    outlines [(2, "#000000", 0, 0)]
...
style history_name_text:
    ...
    color "#c9b28a"   # nombre del personaje (dorado)
    outlines [(2, "#000000", 0, 0)]
